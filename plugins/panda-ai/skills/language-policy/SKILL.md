...
description: Language rules for the panda-ai. Defines which language to use for communication, code, comments, and documentation. Load this skill in all panda-ai agents.
disable-model-invocation: true
---

# Language Policy — Panda Team
